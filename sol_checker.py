...
all_nodes, capacity, empty_vehicle_weight = load_model('dataset/Instance.txt')
test_solution('solutions/FF_OPT_VND_281220231242.txt', all_nodes, capacity, empty_vehicle_weight)